...
bool LightShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, (WCHAR*)L"../Project4/light.vs", (WCHAR*)L"../Project4/light.ps");
	if (!result)
	{
		return false;
	}
...
bool LightShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, D3DXMATRIX worldMatrix,
	...
	, bool ambientSwitch, bool diffuseSwitch, bool specularSwitch)
{
	bool result;
	// Set the shader parameters that it will use for rendering.
	result = SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, texture,
		lightDirection, ambientColor, diffuseColor, cameraPosition, specularColor, specularPower, ambientSwitch, diffuseSwitch, specularSwitch);
	if (!result)
	{
		return false;
	}
...
bool LightShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	if (FAILED(result))
	{
		...
		{
			MessageBox(hwnd, vsFilename, L"Missing Shader File2", MB_OK);
		}
		return false;
	}
	...
	, bool ambientSwitch, bool diffuseSwitch, bool specularSwitch)
{
	...
	dataPtr2->ambientSwitch = ambientSwitch;
	dataPtr2->diffuseSwitch = diffuseSwitch;
	dataPtr2->specularSwitch = specularSwitch;*/
	// Unlock the constant buffer.
