...
bool PointClass::Initialize(ID3D11Device *device, HWND hwnd)
{
	bool result;


	// Initialize the vertex and pixel shaders.
	result = InitializeShader(device, hwnd, (WCHAR *)L"../Project4/pointlight.vs", (WCHAR *)L"../Project4/pointlight.ps");
	if (!result)
	{
		return false;
	}
...
bool PointClass::Render(ID3D11DeviceContext *deviceContext, int indexCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, 
...
bool PointClass::InitializeShader(ID3D11Device *device, HWND hwnd, WCHAR *vsFilename, WCHAR *psFilename)
{
	HRESULT result;
...
void PointClass::ShutdownShader()
{
...
void PointClass::OutputShaderErrorMessage(ID3D10Blob *errorMessage, HWND hwnd, WCHAR *shaderFilename)
{
	char* compileErrors;
...
bool PointClass::SetShaderParameters(ID3D11DeviceContext *deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, 
									D3DXMATRIX projectionMatrix, ID3D11ShaderResourceView * texture, D3DXVECTOR4 diffuseColor[], D3DXVECTOR4 lightPosition[])
{
	HRESULT result;
...
void PointClass::RenderShader(ID3D11DeviceContext *deviceContext, int indexCount)
{
